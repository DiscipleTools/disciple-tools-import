    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                <a href="<?php echo esc_attr( $link ) . 'general' ?>" class="nav-tab <?php ( $tab == 'general' || ! isset( $tab ) ) ? esc_attr_e( 'nav-tab-active', 'dt_import_export' ) : print ''; ?>"><?php esc_attr_e( 'General', 'dt_import_export' ) ?></a>
                <a href="<?php echo esc_attr( $link ) . 'second' ?>" class="nav-tab <?php ( $tab == 'second' ) ? esc_attr_e( 'nav-tab-active', 'dt_import_export' ) : print ''; ?>"><?php esc_attr_e( 'Second', 'dt_import_export' ) ?></a>
            </h2>
